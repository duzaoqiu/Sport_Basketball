package com.player.base.ijkplayer;
...
//        ijkMediaPlayer.native_setLogLevel(IjkMediaPlayer.IJK_LOG_DEBUG);
    ...
    @Override
    public void start() {
        if(available() && (getState()==STATE_PREPARED || getState()==STATE_PAUSED || getState()==STATE_PLAYBACK_COMPLETE)){
            mMediaPlayer.start();
