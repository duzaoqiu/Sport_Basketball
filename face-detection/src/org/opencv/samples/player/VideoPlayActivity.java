package org.opencv.samples.player;
...
public class VideoPlayActivity extends AppCompatActivity {
    ...
    private   String DEFAULT_MEDIA_URI =
            "http://183.136.222.58:18080/basketball-app/file/6668840414323488769";

    private static final String ACTION_VIEW = "org.opencv.samples.facedetect.action.VIEW";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        DEFAULT_MEDIA_URI = getIntent().getStringExtra("path");
