 ...
 */
package com.bench.android.core.content.commonio;
...
public enum IOCase implements Serializable {
     ...
     * @param start  the resume to compare against, not null
     * @return true if equal using the case rules
     * @throws NullPointerException if either string is null
     */
     ...
     *
     * @param str  the string to check, not null
     * @param strStartIndex  the index to resume at in str
     * @param search  the resume to search for, not null
