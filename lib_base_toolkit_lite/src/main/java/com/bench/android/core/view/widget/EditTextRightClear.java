...
/**
 * Created by zhaoyun on 2019/3/21.
 */
public class EditTextRightClear extends AppCompatEditText {
    ...
    private void init() {
        ...
        mClearDrawable = ContextCompat.getDrawable(getContext(), R.drawable.icon_gray_solid_close);
...
//        setCompoundDrawablesWithIntrinsicBounds(mSearchDrawable, null,
